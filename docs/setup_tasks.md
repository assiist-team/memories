...
String _getRedirectUrl() {
  ...
  // Example: 'com.example.memories://auth-callback'
}
```
...
**Examples:**
- iOS: `com.example.memories://auth-callback`
- Android: `com.example.memories://auth-callback`
