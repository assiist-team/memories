...
class MementoCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Format: "Memento titled [title] captured [absolute date], [relative time]"
    final absoluteTime = _formatAbsoluteTimestamp(memento.capturedAt, locale);
    final relativeTime = _formatRelativeTimestamp(memento.capturedAt);
  ...
  Widget _buildContent(BuildContext context, ThemeData theme, Locale locale) {
    return Column(
      ...
      children: [
        ...
        Semantics(
          label: 'Captured ${_formatRelativeTimestamp(memento.capturedAt).isNotEmpty ? _formatRelativeTimestamp(memento.capturedAt) : _formatAbsoluteTimestamp(memento.capturedAt, locale)}',
          excludeSemantics: true,
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              Text(
                _formatRelativeTimestamp(memento.capturedAt).isNotEmpty
                    ? _formatRelativeTimestamp(memento.capturedAt)
  ...
  /// Matches the pattern used in StoryCard for consistency
