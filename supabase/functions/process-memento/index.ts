...
async function generateTitleWithLLM(
  ...
  const prompt = `Generate a concise, engaging title (maximum ${MAX_TITLE_LENGTH} characters) for a special memento or keepsake based on this text. The title should capture the significance and meaning of this memento. Return only the title text, nothing else.
