-- Migration: Add memory_location_data to timeline feed functions
-- Description: Adds memory_location_data field to get_unified_timeline_feed and get_timeline_feed
--              so location can be displayed in timeline cards
...
'grouping metadata (year, season, month) for timeline organization. Includes memory_location_data for location display.';
...
'Includes memory_location_data for location display.';
